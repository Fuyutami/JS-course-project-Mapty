...
class App {
    ...
    _loadMap(position) {
        ...
        this.#map = L.map('map').setView(coords, this.#mapZoomLevel); // we need HTML element with an ID of "map"
    ...
    _renderWorkoutMarker(workout) {
        L.marker(workout.coords, 'riseOnHover').addTo(this.#map).bindPopup(L.popup({
            maxWidth: 250,
            minWidth: 100,
            autoClose: false,
            closeOnClick: false,
